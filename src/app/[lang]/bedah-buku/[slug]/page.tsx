      ...
      <nav aria-label="Breadcrumb">
        <ol className="flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] font-bold uppercase tracking-[0.14em] text-meta">
          ...
          <li className="flex items-center gap-2">
            ...
            <span className="text-ink">{t("Ulasan")}</span>
          </li>
        </ol>
      </nav>
      ...
      {podcast && (
        <div className="mt-12 border-t border-line pt-10">
          ...
          <p className="mt-2 text-sm text-meta">
            {podcast.format} {t("bersama")} {podcast.narasumber} {t("di")} {podcast.media}.
          </p>
          <div className="mt-5">
            <VideoEmbed id={podcast.videoId} title={podcast.headline} />
          </div>
          <Link
            href={l(`/podcast/${podcast.slug}`)}
