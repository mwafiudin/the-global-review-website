...
export function BrandBand() {
  return (
    <section
      aria-label="Tentang The Global Review"
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-14 md:py-20 lg:grid-cols-2 lg:gap-16 lg:px-6">
        ...
        <div>
          ...
          <p className="mt-5 max-w-xl text-[15px] leading-relaxed text-body md:text-base">
            ...
            , lembaga pengkajian geopolitik dan politik luar negeri yang berdiri
            pada 2007. Sejak 2008 kami menyebarluaskan pikiran para pengkaji
            masalah internasional — bukan mengejar kecepatan kabar, melainkan
            kejernihan membaca arah dunia.
          </p>
          <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-body md:text-base">
            Analisis, opini, dan kajian kawasan kami susun untuk pembaca yang
            ingin memahami mengapa sebuah peristiwa terjadi, bukan sekadar
            mengetahui bahwa ia terjadi.
          </p>
